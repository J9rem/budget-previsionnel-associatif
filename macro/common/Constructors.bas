...
Public Function DefaultSheetsNames()
    Dim SheetNames(0 To 10) As String
    ...
    SheetNames(7) = Nom_Feuille_Eupl
    SheetNames(8) = Nom_Feuille_CC_by_SA
    SheetNames(9) = Nom_Feuille_FAQ
    SheetNames(10) = Nom_Feuille_Versions
