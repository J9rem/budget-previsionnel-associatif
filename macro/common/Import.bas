...
Public Function importData(FileName As String) As Boolean
    ...
    ' copie des onglets avant la copie des donn�es pour �viter les erreurs
    ...
    ' copie des onglets avant la copie des donn�es pour �viter les autres erreurs
    ImportSheets oldWorkbook, ThisWorkbook
